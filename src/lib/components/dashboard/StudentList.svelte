								...
								<td class="w-min">
									<button
										...
										on:click={() => {
											...
											editId = item._id;
											editFirstName = item.student_firstname;
											editLastName = item.student_lastname;
											editGrade = item.current_grade;
											editSchoolYear = item.school_year;
										}}>Edit</button
									>
									<button
