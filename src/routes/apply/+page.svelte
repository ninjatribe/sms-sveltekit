...
<div class="flex flex-col justify-center items-center">
	...
	<div class="container p-5 py-6 flex flex-col justify-center sm:py-12">
			...
			<div class="relative text-gray-700 antialiased text-sm font-semibold">
				...
				<div class="mt-6 sm:mt-0 sm:mb-12">
					<div class="flex flex-col sm:flex-row items-center">
						<div
							class="flex justify-start w-full mx-auto items-center intersectClass opacity-0 transform translate-x-20"
						>
							<div class="w-full sm:w-1/2 sm:pr-8">
								...
								<div class="p-4 bg-yellow-300 rounded shadow-3xl sm:w-80">
									...
									<br />
									<p>
										Check out our campus and programs by <a
											href="#top"
											class="text-blue-500 font-bold {hoverWhite}">scheduling a tour</a
										>
										or viewing our
										<a href="#top" class="text-blue-500 font-bold {hoverWhite}"
											>virtual open house</a
										>. You can also contact us by submitting a
										<a href="#top" class="text-blue-500 font-bold {hoverWhite}"
											>new student inquiry</a
										> for answers to more specific questions about enrolling your student at Faith Academy.
									</p>
								</div>
							</div>
						</div>
				...
				<div class="mt-6 sm:mt-0 sm:mb-12">
					<div class="flex flex-col sm:flex-row items-center">
						<div
							class="flex justify-end w-full mx-auto items-center intersectClass opacity-0 transform -translate-x-20"
						>
							<div class="w-full sm:w-1/2 sm:pl-8">
								<div class="p-4 bg-orange-300 rounded shadow-3xl sm:w-80">
									...
									<br />
									<p>
										During the application and enrollment process you’re going to need <a
											href="#top"
											class="text-blue-500 font-bold {hoverWhite}">this checklist</a
										> of things. It’s a good idea to gather them before you begin!
									</p>
								</div>
							</div>
						</div>
						...
						>
							<div class="w-full sm:w-1/2 sm:pr-8">
								<div class="p-4 bg-blue-300 rounded shadow-3xl sm:w-80">
									...
									<br />
									<p>
										To apply for enrollment at Faith Academy <a
											href="#top"
											class="text-blue-500 font-bold {hoverWhite}">start here</a
										>
										with the new student inquiry. To avoid delays, be sure your
										<a href="#top" class="text-blue-500 font-bold {hoverWhite}">application fees</a>
										are <a href="#top" class="text-blue-500 font-bold {hoverWhite}">paid</a> the same
										day your application is submitted. Once your student’s academic application has been
										accepted you may also apply for the boarding program.
									</p>
								</div>
							</div>
						</div>
						...
						>
							<div class="w-full sm:w-1/2 sm:pl-8">
								<div class="p-4 bg-green-300 rounded shadow-3xl sm:w-80">
									...
									<br />
									<p>
										After your application has been accepted, return again to the <a
											href="#top"
											class="text-blue-500 font-bold {hoverWhite}">registration portal</a
										> to finish the enrollment process. At this time you may also apply for boarding.
									</p>
									<br />
									<p>
										New students will reserve their space by paying the <a
											href="#top"
											class="text-blue-500 font-bold {hoverWhite}">seat deposit</a
										> the first year only. Every year you will submit updated health information, review
										child safety information, and a few other things. Once these things are complete
										your student will be ready to attend classes!
									</p>
								</div>
							</div>
						</div>
		...
		<div class="self-center w-full mt-20 flex flex-col justify-center items-center">
			<div
				class="flex justify-between items-center w-60 bg-blue-900 hover:bg-blue-500 cursor-pointer {hoverBase} text-white shadow-2xl rounded-md bold px-4 p-2"
			>
				<a href="apply/new_student_inquiry" class="text-white">New Student Inquiry</a>
				<img src={arrowRight} alt="" class="w-10 h-10 invert" />
			</div>
			<div
				class="mt-4 flex flex-col items-center justify-center text-lg text-black font-bold bg-yellow-300 hover:bg-yellow-500 {hoverBase} cursor-pointer p-2 rounded-lg"
			>
			...
			<p class="font-bold mt-4">
				Already started an application or looking for re-enrollment? <a
					href="/auth/login"
					class="text-blue-300 hover:text-blue-500 font-bold {hoverBase}">Login here.</a
				>
			</p>
		</div>
	</div>
