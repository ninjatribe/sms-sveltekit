...
<div class="main-wrapper">
	...
	<!-- 1st image -->
	<div
		class="mt-2 w-full h-full bg-center bg-cover bg-fixed"
		style="background-image: url({main_home})"
	>
		...
		<div class="animated first flex justify-center opacity-0 translate-y-72 py-60 cursor-default">
			<div
				class="flex flex-col justify-center uppercase text-2xl lg:text-3xl p-2 font-bold text-white "
			>
				<p class="bg-blue-300 w-min h-full font-quicksand pl-2 pr-10">Transformative,</p>
				<div
					class="flex flex-col lg:flex-row flex-wrap items-center justify-center bg-blue-300 p-2 lg:gap-2 translate-x-5"
				>
		...
		<div class="flex items-center justify-center lg:justify-end w-full">
			<div class="border-4 border-blue-400">
				<img
					src={group_photo}
					alt="group_photo"
					class="pointer-events-none h-60 sm:h-96 bg-green-500 object-cover translate-x-4 translate-y-4"
				/>
			</div>
		</div>
		<div
			class="animated second flex flex-col items-center lg:items-start w-full translate-x-20 opacity-0 cursor-default"
		>
			<div
				class="uppercase font-bold text-4xl sm:text-5xl text-white -translate-x-4 lg:-translate-x-24"
			>
				<p class="bg-blue-900 p-1">Welcome to</p>
				<p class="bg-blue-900 p-2 translate-x-10">faith academy</p>
			</div>
			<p class="w-96 text-blue-900 mt-2 text-xl">
				Faith Academy is recognized as an international leader in providing a well-rounded
				educational experience for third-culture kids, located just outside Manila, Philippines.
			</p>
			<br />
			<a href="/about">
				<p class="text-blue-400 hover:text-blue-600 transition-all duration-400 ease-in">
					LEARN MORE ABOUT US
				</p>
			</a>
		</div>
	...
	<div class="bg-blue-200 py-20 cursor-default">
		<div
			class="animated fourth flex flex-col lg:flex-row items-center justify-center opacity-0 -translate-y-20"
		>
			<p class="font-kaushan text-end p-5 lg:pl-52 text-5xl text-blue-900 font-bold">Mission</p>
			<p class="w-96 font-sans text-xl px-4 lg:p-0 text-slate-700 font-semibold">
				Forming Christlike, lifelong learners through a dynamic, relevant education, especially for
	...
	<div class="py-24 flex justify-center flex-col lg:flex-row items-center gap-6 cursor-default">
		<div class="lg:order-2 border-4 border-green-600 grow-0">
			<iframe
				class="-translate-x-4 translate-y-4"
				bind:this={embeddedVideo}
				src="https://player.vimeo.com/video/219770193?h=7fccb28631&color=9fc1e6"
				width="256"
				height="144"
				frameborder="0"
				allow="fullscreen; picture-in-picture;"
				allowfullscreen
				title="Cultivating Hearts and Minds for Christ at Faith Academy"
			/>
		</div>
		<div
			class="animated third w-96 lg:order-1 flex flex-col items-end font-quicksand font-semibold text-lg -translate-x-20 opacity-0"
		>
			<p class="text-end text-blue-900">
				“Faith Academy has been a place that’s pushed me to perform to the best of my abilities
				while still remaining a community that nurtures and guides me through my walk with God.”
			</p>
			<br />
	...
	<div class="flex flex-col lg:flex-row pb-2 bg-blue-900">
		<div class="relative overflow-hidden group h-80 lg:h-auto">
			<img
				src={elementary}
				alt="elementary"
				class="pointer-events-none h-full w-full object-cover brightness-50 group-hover:brightness-100 saturate-50 group-hover:saturate-100 transition-all duration-500 ease-in-out"
			/>
			<div
				class="absolute top-1/2 w-full h-full flex flex-col justify-between items-center group-hover:-translate-y-3/4 animation duration-700 ease-in-out"
			>
				<p class="text-5xl font-kaushan text-white cursor-default">Elementary</p>
				<a
					href="/school_life/elementary"
					class="text-slate-700 text-lg p-5 bg-slate-200 hover:bg-slate-400 transition-all duration-300 cursor-pointer"
					>Learn more</a
				>
			</div>
		</div>
		<div class="relative overflow-hidden group h-80 lg:h-auto">
			<img
				src={middle_school}
				alt="middle_school"
				class="pointer-events-none h-full w-full object-cover object-top brightness-50 group-hover:brightness-100 saturate-50 group-hover:saturate-100 transition-all duration-500 ease-in-out"
			/>
			<div
				class="absolute top-1/2 w-full h-full flex flex-col justify-between items-center group-hover:-translate-y-3/4 animation duration-700 ease-in-out"
			>
				...
				<a
					href="/school_life/middle_school"
					class="text-slate-700 text-lg p-5 bg-slate-200 hover:bg-slate-400 transition-all duration-300 cursor-pointer"
					>Learn more</a
				>
			</div>
		...
		<div class="relative overflow-hidden group h-80 lg:h-auto">
			<img
				src={high_school}
				alt="high_school"
				class="pointer-events-none h-full w-full object-cover object-bottom brightness-50 group-hover:brightness-100 saturate-50 group-hover:saturate-100 transition-all duration-500 ease-in-out"
			/>
			<div
				class="absolute top-1/2 w-full h-full flex flex-col justify-between items-center group-hover:-translate-y-3/4 animation duration-700 ease-in-out"
			>
	...
	<div class="bg-blue-900 p-2 py-20 text-lg">
		<div
			class="animated fifth flex flex-col lg:flex-row justify-center items-center gap-4 text-white opacity-0 -translate-y-20"
		>
			<p class="text-center cursor-default">
				<b>Learn more</b> about our admission process, <b>register</b> your student, or <b>apply</b>
				here!
			</p>
			<a
				href="/apply"
				class="py-2 px-6 bg-blue-400 text-xl text-slate-100 hover:bg-yellow-300 hover:text-slate-600 transition-all duration-300 ease-in-out"
				>Register</a
			>
		</div>
	</div>
...
<div class="aside absolute lg:hidden top-0 w-full h-full bg-blue-900" class:open>
	<div class="flex flex-col my-28">
		...
		<div class="flex justify-center gap-2 mt-2 p-2">
			<a
				href="https://www.facebook.com/faithacademymanila/"
				target="_blank"
				rel="noreferrer"
				class="w-10"
				><img
			...
			>
			<a
				href="https://www.instagram.com/faithacademymanila/"
				target="_blank"
				rel="noreferrer"
				class="w-10"
				><img
				...
				/></a
			>
			<a href="https://vimeo.com/faithacademymanila" target="_blank" rel="noreferrer" class="w-10"
				><img
					src={vimeo_logo}
					alt="vimeo"
					class="transition duration-300 ease-in-out hover:rotate-12"
			...
			>
			<a
				href="https://www.youtube.com/c/FaithAcademyManilaOfficial"
				target="_blank"
				rel="noreferrer"
				class="w-10"
				><img
